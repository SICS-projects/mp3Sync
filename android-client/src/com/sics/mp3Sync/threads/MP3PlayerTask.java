...
import com.sics.mp3Sync.eventListener.MediaPlayerGUIListenerInterface;
...
public class MP3PlayerTask extends AsyncTask<View, Integer, byte[]> {
	...
	private MediaPlayerGUIListenerInterface listener;
	...
	protected void onProgressUpdate(Integer... progress) {
		...
		if (this.thingsToUpdate == 2){
			...
			if (listener != null){
				this.listener.onFinishedPlaying();
			}
		}
	}
	...
	public void setOnMediaPlayerGUIListener(MediaPlayerGUIListenerInterface listener){
